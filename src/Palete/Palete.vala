...
namespace Palete 
{
    ...
    public abstract class Palete : Object 
    {
        ...
        public void saveTemplate (string name, JsRender.Node data)
        {
            ...
            var appdir =  BuilderApplication.configDirectory(); 
        ...
        public  GLib.List<string> listTemplates (JsRender.Node node)
        {
			...
			var dir= BuilderApplication.configDirectory() + "/" + gn;
		...
		public abstract void loadNodeDefaults(SymbolLoader? sl, JsRender.Node ret);
