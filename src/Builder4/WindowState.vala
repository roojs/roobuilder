...
public class WindowState : Object 
{
	...
	*/
	...
	public void projectPopoverShow(Gtk.Window pwin, Project.Project? pr, GLib.VoidFunc? donefunc) 
	{ 
		if (pr == null) {
		    pr = this.project;
	    }
		...
		this.vala_projectsettings_pop.show(pwin,(Project.Gtk)pr,  donefunc);
