...
public class GladeView : Object
{
    ...
    public class Xcls_ComboBox5 : Object
    {
        ...
        public Xcls_ComboBox5(GladeView _owner )
        {
            ...
            var child_0 = new Xcls_TreeStore6( _this );
            child_0.ref();
    ...
    public class Xcls_TreeStore6 : Object
    {
        ...
        // ctor
        public Xcls_TreeStore6(GladeView _owner )
        {
            _this = _owner;
            this.el = new Gtk.TreeStore( 0, typeof(string) );
