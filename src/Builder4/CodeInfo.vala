...
public class CodeInfo : Object
{
	...
	public class Xcls_pane : Object
	{
		...
		public Xcls_pane(CodeInfo _owner )
		{
			...
			var child_3 = new Xcls_Box945( _this );
			child_3.ref();
	...
	public class Xcls_Box945 : Object
	{
		public Gtk.Box el;
		private CodeInfo  _this;
		...
		// ctor
		public Xcls_Box945(CodeInfo _owner )
		{
			_this = _owner;
			this.el = new Gtk.Box( Gtk.Orientation.HORIZONTAL, 0 );
			...
			// set gobject values
			var child_1 = new Xcls_Box946( _this );
			child_1.ref();
			this.el.append( child_1.el );
			var child_2 = new Xcls_SearchBar953( _this );
			child_2.ref();
			this.el.append( child_2.el );
			var child_3 = new Xcls_Button955( _this );
			child_3.ref();
			this.el.append( child_3.el );
			new Xcls_combo( _this );
			this.el.append( _this.combo.el );
			var child_5 = new Xcls_Button958( _this );
			child_5.ref();
			this.el.append( child_5.el );
		}
	...
	public class Xcls_Box946 : Object
	{
		public Gtk.Box el;
		private CodeInfo  _this;
		...
		// ctor
		public Xcls_Box946(CodeInfo _owner )
		{
			_this = _owner;
			this.el = new Gtk.Box( Gtk.Orientation.HORIZONTAL, 0 );
			...
			new Xcls_next_button( _this );
			this.el.append( _this.next_button.el );
			var child_3 = new Xcls_Label949( _this );
			child_3.ref();
			this.el.append( child_3.el );
			new Xcls_toggle_method( _this );
			this.el.append( _this.toggle_method.el );
	...
	public class Xcls_Label949 : Object
	{
		public Gtk.Label el;
		private CodeInfo  _this;
		...
		// ctor
		public Xcls_Label949(CodeInfo _owner )
		{
			_this = _owner;
			this.el = new Gtk.Label( null );
	...
	public class Xcls_SearchBar953 : Object
	{
		public Gtk.SearchBar el;
		private CodeInfo  _this;
		...
		// ctor
		public Xcls_SearchBar953(CodeInfo _owner )
		{
			_this = _owner;
			this.el = new Gtk.SearchBar();
	...
	public class Xcls_Button955 : Object
	{
		public Gtk.Button el;
		private CodeInfo  _this;
		...
		// ctor
		public Xcls_Button955(CodeInfo _owner )
		{
			_this = _owner;
			this.el = new Gtk.Button();
	...
	public class Xcls_Button958 : Object
	{
		public Gtk.Button el;
		private CodeInfo  _this;
		...
		// ctor
		public Xcls_Button958(CodeInfo _owner )
		{
			_this = _owner;
			this.el = new Gtk.Button();
