...
public class Xcls_MainWindow : Object
{
	...
	public Xcls_file_paned file_paned;
	...
	public class Xcls_Box42 : Object
	{
		...
		public Xcls_Box42(Xcls_MainWindow _owner )
		{
			...
			var child_4 = new Xcls_Button73( _this );
			child_4.ref();
	...
	public class Xcls_vbox : Object
	{
		...
		public Xcls_vbox(Xcls_MainWindow _owner )
		{
			...
			var child_2 = new Xcls_Box134( _this );
			child_2.ref();
	...
	public class Xcls_Box134 : Object
	{
		public Gtk.Box el;
		private Xcls_MainWindow  _this;
		...
		// ctor
		public Xcls_Box134(Xcls_MainWindow _owner )
		{
			_this = _owner;
			this.el = new Gtk.Box( Gtk.Orientation.HORIZONTAL, 0 );
			...
			this.el.homogeneous = false;
			this.el.vexpand = false;
			var child_1 = new Xcls_Button138( _this );
			child_1.ref();
			this.el.append( child_1.el );
			var child_2 = new Xcls_Button150( _this );
			child_2.ref();
			this.el.append( child_2.el );
			var child_3 = new Xcls_MenuButton162( _this );
			child_3.ref();
			this.el.append( child_3.el );
			var child_4 = new Xcls_Label180( _this );
			child_4.ref();
			this.el.append( child_4.el );
			new Xcls_statusbar( _this );
			this.el.append( _this.statusbar.el );
			var child_6 = new Xcls_Box188( _this );
			child_6.ref();
	...
	public class Xcls_Button138 : Object
	{
		public Gtk.Button el;
		private Xcls_MainWindow  _this;
		...
		// ctor
		public Xcls_Button138(Xcls_MainWindow _owner )
		{
			_this = _owner;
			this.el = new Gtk.Button();
			...
			var child_1 = new Xcls_Box140( _this );
			child_1.ref();
	...
	public class Xcls_Box140 : Object
	{
		public Gtk.Box el;
		private Xcls_MainWindow  _this;
		...
		// ctor
		public Xcls_Box140(Xcls_MainWindow _owner )
		{
			_this = _owner;
			this.el = new Gtk.Box( Gtk.Orientation.HORIZONTAL, 0 );
			...
			// set gobject values
			var child_1 = new Xcls_Image143( _this );
			child_1.ref();
			this.el.append( child_1.el );
	...
	public class Xcls_Image143 : Object
	{
		public Gtk.Image el;
		private Xcls_MainWindow  _this;
		...
		// ctor
		public Xcls_Image143(Xcls_MainWindow _owner )
		{
			_this = _owner;
	...
	public class Xcls_Button150 : Object
	{
		public Gtk.Button el;
		private Xcls_MainWindow  _this;
		...
		// ctor
		public Xcls_Button150(Xcls_MainWindow _owner )
		{
			_this = _owner;
			this.el = new Gtk.Button();
			...
			var child_1 = new Xcls_Box152( _this );
			child_1.ref();
			this.el.child = child_1.el;
	...
	public class Xcls_Box152 : Object
	{
		public Gtk.Box el;
		private Xcls_MainWindow  _this;
		...
		// ctor
		public Xcls_Box152(Xcls_MainWindow _owner )
		{
			_this = _owner;
			this.el = new Gtk.Box( Gtk.Orientation.HORIZONTAL, 0 );
			...
			// set gobject values
			var child_1 = new Xcls_Image155( _this );
			child_1.ref();
			this.el.append( child_1.el );
	...
	public class Xcls_Image155 : Object
	{
		public Gtk.Image el;
		private Xcls_MainWindow  _this;
		...
		// ctor
		public Xcls_Image155(Xcls_MainWindow _owner )
		{
			_this = _owner;
			this.el = new Gtk.Image();
	...
	public class Xcls_MenuButton162 : Object
	{
		...
		// ctor
		public Xcls_MenuButton162(Xcls_MainWindow _owner )
		{
			_this = _owner;
	...
	public class Xcls_topbarmenu : Object
	{
		...
		public Xcls_topbarmenu(Xcls_MainWindow _owner )
		{
			...
			// set gobject values
			var child_1 = new Xcls_Box168( _this );
			child_1.ref();
	...
	public class Xcls_Box168 : Object
	{
		public Gtk.Box el;
		private Xcls_MainWindow  _this;
		...
		// ctor
		public Xcls_Box168(Xcls_MainWindow _owner )
		{
			_this = _owner;
			this.el = new Gtk.Box( Gtk.Orientation.VERTICAL, 0 );
			...
			// set gobject values
			var child_1 = new Xcls_Button172( _this );
			child_1.ref();
			this.el.append( child_1.el );
			var child_2 = new Xcls_Button175( _this );
			child_2.ref();
			this.el.append( child_2.el );
		}
	...
	public class Xcls_Button172 : Object
	{
		public Gtk.Button el;
		private Xcls_MainWindow  _this;
		...
		// ctor
		public Xcls_Button172(Xcls_MainWindow _owner )
		{
			_this = _owner;
			this.el = new Gtk.Button();
	...
	public class Xcls_Button175 : Object
	{
		public Gtk.Button el;
		private Xcls_MainWindow  _this;
		...
		// ctor
		public Xcls_Button175(Xcls_MainWindow _owner )
		{
			_this = _owner;
			this.el = new Gtk.Button();
	...
	public class Xcls_Label180 : Object
	{
		public Gtk.Label el;
		private Xcls_MainWindow  _this;
		...
		// ctor
		public Xcls_Label180(Xcls_MainWindow _owner )
		{
			_this = _owner;
	...
	public class Xcls_Box188 : Object
	{
		public Gtk.Box el;
		private Xcls_MainWindow  _this;
		...
		// ctor
		public Xcls_Box188(Xcls_MainWindow _owner )
		{
			_this = _owner;
			this.el = new Gtk.Box( Gtk.Orientation.HORIZONTAL, 0 );
	...
	public class Xcls_statusbar_errors : Object
	{
		...
		public Xcls_statusbar_errors(Xcls_MainWindow _owner )
		{
			...
			// set gobject values
			var child_1 = new Xcls_Box198( _this );
			child_1.ref();
			this.el.child = child_1.el;
	...
	public class Xcls_Box198 : Object
	{
		public Gtk.Box el;
		private Xcls_MainWindow  _this;
		...
		// ctor
		public Xcls_Box198(Xcls_MainWindow _owner )
		{
			_this = _owner;
			this.el = new Gtk.Box( Gtk.Orientation.HORIZONTAL, 0 );
			...
			// set gobject values
			var child_1 = new Xcls_Image201( _this );
			child_1.ref();
			this.el.append( child_1.el );
	...
	public class Xcls_Image201 : Object
	{
		public Gtk.Image el;
		private Xcls_MainWindow  _this;
		...
		// ctor
		public Xcls_Image201(Xcls_MainWindow _owner )
		{
			_this = _owner;
			this.el = new Gtk.Image();
	...
	public class Xcls_statusbar_warnings : Object
	{
		...
		public Xcls_statusbar_warnings(Xcls_MainWindow _owner )
		{
			...
			// set gobject values
			var child_1 = new Xcls_Box212( _this );
			child_1.ref();
			this.el.child = child_1.el;
	...
	public class Xcls_Box212 : Object
	{
		public Gtk.Box el;
		private Xcls_MainWindow  _this;
		...
		// ctor
		public Xcls_Box212(Xcls_MainWindow _owner )
		{
			_this = _owner;
			this.el = new Gtk.Box( Gtk.Orientation.HORIZONTAL, 0 );
			...
			// set gobject values
			var child_1 = new Xcls_Image215( _this );
			child_1.ref();
			this.el.append( child_1.el );
	...
	public class Xcls_Image215 : Object
	{
		public Gtk.Image el;
		private Xcls_MainWindow  _this;
		...
		// ctor
		public Xcls_Image215(Xcls_MainWindow _owner )
		{
			_this = _owner;
			this.el = new Gtk.Image();
	...
	public class Xcls_statusbar_depricated : Object
	{
		...
		public Xcls_statusbar_depricated(Xcls_MainWindow _owner )
		{
			...
			// set gobject values
			var child_1 = new Xcls_Box227( _this );
			child_1.ref();
			this.el.child = child_1.el;
	...
	public class Xcls_Box227 : Object
	{
		public Gtk.Box el;
		private Xcls_MainWindow  _this;
		...
		// ctor
		public Xcls_Box227(Xcls_MainWindow _owner )
		{
			_this = _owner;
			this.el = new Gtk.Box( Gtk.Orientation.HORIZONTAL, 0 );
			...
			// set gobject values
			var child_1 = new Xcls_Image230( _this );
			child_1.ref();
			this.el.append( child_1.el );
	...
	public class Xcls_Image230 : Object
	{
		public Gtk.Image el;
		private Xcls_MainWindow  _this;
		...
		// ctor
		public Xcls_Image230(Xcls_MainWindow _owner )
		{
			_this = _owner;
			this.el = new Gtk.Image();
	...
	public class Xcls_statusbar_run : Object
	{
		...
		public Xcls_statusbar_run(Xcls_MainWindow _owner )
		{
			...
			// set gobject values
			this.el.visible = false;
			var child_1 = new Xcls_Box243( _this );
			child_1.ref();
			this.el.child = child_1.el;
	...
	public class Xcls_Box243 : Object
	{
		public Gtk.Box el;
		private Xcls_MainWindow  _this;
		...
		// ctor
		public Xcls_Box243(Xcls_MainWindow _owner )
		{
			_this = _owner;
			this.el = new Gtk.Box( Gtk.Orientation.HORIZONTAL, 0 );
			...
			// set gobject values
			var child_1 = new Xcls_Image246( _this );
			child_1.ref();
			this.el.append( child_1.el );
			var child_2 = new Xcls_Label249( _this );
			child_2.ref();
			this.el.append( child_2.el );
		}
	...
	public class Xcls_Image246 : Object
	{
		public Gtk.Image el;
		private Xcls_MainWindow  _this;
		...
		// ctor
		public Xcls_Image246(Xcls_MainWindow _owner )
		{
			_this = _owner;
			this.el = new Gtk.Image();
	...
	public class Xcls_Label249 : Object
	{
		public Gtk.Label el;
		private Xcls_MainWindow  _this;
		...
		// ctor
		public Xcls_Label249(Xcls_MainWindow _owner )
		{
			_this = _owner;
	...
	public class Xcls_sidebar : Object
	{
		...
		public Xcls_sidebar(Xcls_MainWindow _owner )
		{
			...
			var child_2 = new Xcls_Box277( _this );
			child_2.ref();
			this.el.append( child_2.el );
			new Xcls_file_paned( _this );
			this.el.append( _this.file_paned.el );
		}
	...
	public class Xcls_filesearch : Object
	{
		...
		public Xcls_filesearch(Xcls_MainWindow _owner )
		{
			...
			var child_1 = new Xcls_EventControllerKey272( _this );
			child_1.ref();
	...
	public class Xcls_EventControllerKey272 : Object
	{
		...
		// ctor
		public Xcls_EventControllerKey272(Xcls_MainWindow _owner )
		{
			_this = _owner;
	...
	public class Xcls_Box277 : Object
	{
		public Gtk.Box el;
		private Xcls_MainWindow  _this;
		...
		// ctor
		public Xcls_Box277(Xcls_MainWindow _owner )
		{
			_this = _owner;
			this.el = new Gtk.Box( Gtk.Orientation.HORIZONTAL, 0 );
			...
			var child_2 = new Xcls_Button294( _this );
			child_2.ref();
			this.el.append( child_2.el );
		}
	...
	public class Xcls_open_projects_btn : Object
	{
		...
		public Xcls_open_projects_btn(Xcls_MainWindow _owner )
		{
			...
			// set gobject values
			this.el.hexpand = true;
			var child_1 = new Xcls_Box284( _this );
			child_1.ref();
			this.el.child = child_1.el;
	...
	public class Xcls_Box284 : Object
	{
		public Gtk.Box el;
		private Xcls_MainWindow  _this;
		...
		// ctor
		public Xcls_Box284(Xcls_MainWindow _owner )
		{
			_this = _owner;
			this.el = new Gtk.Box( Gtk.Orientation.HORIZONTAL, 0 );
			...
			// set gobject values
			var child_1 = new Xcls_Image287( _this );
			child_1.ref();
			this.el.append( child_1.el );
			var child_2 = new Xcls_Label290( _this );
			child_2.ref();
			this.el.append( child_2.el );
		}
	...
	public class Xcls_Image287 : Object
	{
		public Gtk.Image el;
		private Xcls_MainWindow  _this;
		...
		// ctor
		public Xcls_Image287(Xcls_MainWindow _owner )
		{
			_this = _owner;
			this.el = new Gtk.Image();
	...
	public class Xcls_Label290 : Object
	{
		public Gtk.Label el;
		private Xcls_MainWindow  _this;
		...
		// ctor
		public Xcls_Label290(Xcls_MainWindow _owner )
		{
			_this = _owner;
	...
	public class Xcls_Button294 : Object
	{
		public Gtk.Button el;
		private Xcls_MainWindow  _this;
		...
		// ctor
		public Xcls_Button294(Xcls_MainWindow _owner )
		{
			_this = _owner;
			this.el = new Gtk.Button();
			...
			// set gobject values
			this.el.hexpand = true;
			var child_1 = new Xcls_Box296( _this );
			child_1.ref();
			this.el.child = child_1.el;
	...
	public class Xcls_Box296 : Object
	{
		public Gtk.Box el;
		private Xcls_MainWindow  _this;
		...
		// ctor
		public Xcls_Box296(Xcls_MainWindow _owner )
		{
			_this = _owner;
			this.el = new Gtk.Box( Gtk.Orientation.HORIZONTAL, 0 );
			...
			// set gobject values
			var child_1 = new Xcls_Image299( _this );
			child_1.ref();
			this.el.append( child_1.el );
			var child_2 = new Xcls_Label302( _this );
			child_2.ref();
			this.el.append( child_2.el );
		}
	...
	public class Xcls_Image299 : Object
	{
		public Gtk.Image el;
		private Xcls_MainWindow  _this;
		...
		// ctor
		public Xcls_Image299(Xcls_MainWindow _owner )
		{
			_this = _owner;
			this.el = new Gtk.Image();
	...
	public class Xcls_Label302 : Object
	{
		public Gtk.Label el;
		private Xcls_MainWindow  _this;
		...
		// ctor
		public Xcls_Label302(Xcls_MainWindow _owner )
		{
			_this = _owner;
	...
	public class Xcls_file_paned : Object
	{
		public Gtk.Paned el;
		private Xcls_MainWindow  _this;
		...
		// ctor
		public Xcls_file_paned(Xcls_MainWindow _owner )
		{
			_this = _owner;
			_this.file_paned = this;
			...
			// set gobject values
			this.el.vexpand = true;
			var child_1 = new Xcls_ScrolledWindow309( _this );
			child_1.ref();
	...
	public class Xcls_ScrolledWindow309 : Object
	{
		...
		// ctor
		public Xcls_ScrolledWindow309(Xcls_MainWindow _owner )
		{
			_this = _owner;
			...
			// set gobject values
			this.el.has_frame = true;
			var child_1 = new Xcls_ColumnView311( _this );
			child_1.ref();
			this.el.child = child_1.el;
		}
	...
	public class Xcls_ColumnView311 : Object
	{
		...
		// ctor
		public Xcls_ColumnView311(Xcls_MainWindow _owner )
		{
			_this = _owner;
	...
	public class Xcls_winsel : Object
	{
		...
		public Xcls_winsel(Xcls_MainWindow _owner )
		{
			_this = _owner;
			_this.winsel = this;
			var child_1 = new Xcls_SortListModel317( _this );
			child_1.ref();
	...
	public class Xcls_SortListModel317 : Object
	{
		...
		// ctor
		public Xcls_SortListModel317(Xcls_MainWindow _owner )
		{
			_this = _owner;
			new Xcls_winfilter( _this );
			var child_2 = new Xcls_StringSorter329( _this );
			child_2.ref();
	...
	public class Xcls_windowsearch : Object
	{
		...
		public Xcls_windowsearch(Xcls_MainWindow _owner )
		{
			...
			var child_1 = new Xcls_PropertyExpression322( _this );
			child_1.ref();
	...
	public class Xcls_PropertyExpression322 : Object
	{
		...
		// ctor
		public Xcls_PropertyExpression322(Xcls_MainWindow _owner )
		{
			_this = _owner;
	...
	public class Xcls_StringSorter329 : Object
	{
		...
		// ctor
		public Xcls_StringSorter329(Xcls_MainWindow _owner )
		{
			_this = _owner;
			var child_1 = new Xcls_PropertyExpression331( _this );
			child_1.ref();
	...
	public class Xcls_PropertyExpression331 : Object
	{
		public Gtk.PropertyExpression el;
		private Xcls_MainWindow  _this;
		...
		// ctor
		public Xcls_PropertyExpression331(Xcls_MainWindow _owner )
		{
			_this = _owner;
			this.el = new Gtk.PropertyExpression( typeof(WindowState), null, "file_name" );
	...
	public class Xcls_projcol : Object
	{
		...
		public Xcls_projcol(Xcls_MainWindow _owner )
		{
			_this = _owner;
			_this.projcol = this;
			var child_1 = new Xcls_SignalListItemFactory340( _this );
			child_1.ref();
	...
	public class Xcls_SignalListItemFactory340 : Object
	{
		...
		// ctor
		public Xcls_SignalListItemFactory340(Xcls_MainWindow _owner )
		{
			_this = _owner;
	...
	public class Xcls_filecol : Object
	{
		...
		public Xcls_filecol(Xcls_MainWindow _owner )
		{
			_this = _owner;
			_this.filecol = this;
			var child_1 = new Xcls_SignalListItemFactory349( _this );
			child_1.ref();
	...
	public class Xcls_SignalListItemFactory349 : Object
	{
		public Gtk.SignalListItemFactory el;
		private Xcls_MainWindow  _this;
		...
		// ctor
		public Xcls_SignalListItemFactory349(Xcls_MainWindow _owner )
		{
			_this = _owner;
			this.el = new Gtk.SignalListItemFactory();
	...
	public class Xcls_treescroll : Object
	{
		...
		public Xcls_treescroll(Xcls_MainWindow _owner )
		{
			...
			//listeners
			this.el.notify["visible"].connect( () => {
				if (_this.treescroll.el.visible) {
					_this.file_paned.updatePanedHeight();
				}
			});
	...
	public class Xcls_treeview : Object
	{
		...
		public Xcls_treeview(Xcls_MainWindow _owner )
		{
			...
			this.el.hexpand = true;
			this.el.vexpand = true;
			var child_2 = new Xcls_GestureClick364( _this );
			child_2.ref();
	...
	public class Xcls_GestureClick364 : Object
	{
		...
		// ctor
		public Xcls_GestureClick364(Xcls_MainWindow _owner )
		{
			_this = _owner;
	...
	public class Xcls_treeselmodel : Object
	{
		...
		public Xcls_treeselmodel(Xcls_MainWindow _owner )
		{
			...
			var child_1 = new Xcls_FilterListModel370( _this );
			child_1.ref();
			this.el = new Gtk.SingleSelection( child_1.el );
	...
	public class Xcls_FilterListModel370 : Object
	{
		public Gtk.FilterListModel el;
		private Xcls_MainWindow  _this;
		...
		// ctor
		public Xcls_FilterListModel370(Xcls_MainWindow _owner )
		{
			_this = _owner;
	...
	public class Xcls_treelistsort : Object
	{
		...
		public Xcls_treelistsort(Xcls_MainWindow _owner )
		{
			...
			var child_2 = new Xcls_TreeListRowSorter382( _this );
			child_2.ref();
	...
	public class Xcls_TreeListRowSorter382 : Object
	{
		...
		// ctor
		public Xcls_TreeListRowSorter382(Xcls_MainWindow _owner )
		{
			_this = _owner;
			var child_1 = new Xcls_StringSorter383( _this );
			child_1.ref();
	...
	public class Xcls_StringSorter383 : Object
	{
		public Gtk.StringSorter el;
		private Xcls_MainWindow  _this;
		...
		// ctor
		public Xcls_StringSorter383(Xcls_MainWindow _owner )
		{
			_this = _owner;
			var child_1 = new Xcls_PropertyExpression385( _this );
			child_1.ref();
			this.el = new Gtk.StringSorter( child_1.el );
	...
	public class Xcls_PropertyExpression385 : Object
	{
		public Gtk.PropertyExpression el;
		private Xcls_MainWindow  _this;
		...
		// ctor
		public Xcls_PropertyExpression385(Xcls_MainWindow _owner )
		{
			_this = _owner;
	...
	public class Xcls_name : Object
	{
		...
		public Xcls_name(Xcls_MainWindow _owner )
		{
			_this = _owner;
			_this.name = this;
			var child_1 = new Xcls_SignalListItemFactory397( _this );
			child_1.ref();
	...
	public class Xcls_SignalListItemFactory397 : Object
	{
		public Gtk.SignalListItemFactory el;
		private Xcls_MainWindow  _this;
		...
		// ctor
		public Xcls_SignalListItemFactory397(Xcls_MainWindow _owner )
		{
			_this = _owner;
			this.el = new Gtk.SignalListItemFactory();
