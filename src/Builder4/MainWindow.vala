...
public class Xcls_MainWindow : Object
{
    ...
    public Xcls_MainWindow()
    {
        ...
        BuilderApplication
            BuilderApplication.application.quit();
         }
        });
    }
    ...
    public class Xcls_windowbtn : Object
    {
        ...
        public Xcls_windowbtn(Xcls_MainWindow _owner )
        {
            ...
            var child_1 = new Xcls_PopoverMenu7( _this );
            child_1.ref();
    ...
    public class Xcls_Image6 : Object
    {
        ...
        // ctor
        public Xcls_Image6(Xcls_MainWindow _owner )
        {
            _this = _owner;
    ...
    public class Xcls_PopoverMenu7 : Object
    {
        ...
        // ctor
        public Xcls_PopoverMenu7(Xcls_MainWindow _owner )
        {
            _this = _owner;
    ...
    public class Xcls_Image30 : Object
    {
        ...
        // ctor
        public Xcls_Image30(Xcls_MainWindow _owner )
        {
            _this = _owner;
            this.el = new Gtk.Image();
    ...
    public class Xcls_Box48 : Object
    {
        ...
        public Xcls_Box48(Xcls_MainWindow _owner )
        {
            ...
            child_0.ref();
            this.el.append(  child_0.el );
            var child_1 = new Xcls_Label50( _this );
            child_1.ref();
            this.el.append(  child_1.el );
        }
