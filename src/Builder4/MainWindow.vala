...
public class Xcls_MainWindow : Object
{
	...
	public class Xcls_Shortcut3 : Object
	{
		...
		public Xcls_Shortcut3(Xcls_MainWindow _owner )
		{
			...
			child_1.ref();
			this.el = new Gtk.Shortcut( child_1.el, null );
	...
	public class Xcls_Button7 : Object
	{
		...
		public Xcls_Button7(Xcls_MainWindow _owner )
		{
			...
			var child_1 = new Xcls_ButtonContent8( _this );
	...
	public class Xcls_ButtonContent8 : Object
	{
		...
		// ctor
		public Xcls_ButtonContent8(Xcls_MainWindow _owner )
		{
			_this = _owner;
	...
	public class Xcls_Box19 : Object
	{
		...
		public Xcls_Box19(Xcls_MainWindow _owner )
		{
			...
			child_2.ref();
			this.el.append( child_2.el );
			var child_3 = new Xcls_MenuButton22( _this );
			child_3.ref();
			...
			var child_6 = new Xcls_Box29( _this );
			child_6.ref();
	...
	public class Xcls_Box24 : Object
	{
		...
		// ctor
		public Xcls_Box24(Xcls_MainWindow _owner )
		{
			_this = _owner;
			this.el = new Gtk.Box( Gtk.Orientation.VERTICAL, 0 );
	...
	public class Xcls_Box29 : Object
	{
		...
		// ctor
		public Xcls_Box29(Xcls_MainWindow _owner )
		{
			_this = _owner;
			this.el = new Gtk.Box( Gtk.Orientation.HORIZONTAL, 0 );
	...
	public class Xcls_Box37 : Object
	{
		...
		public Xcls_Box37(Xcls_MainWindow _owner )
		{
			...
			// set gobject values
			var child_1 = new Xcls_SearchBar38( _this );
			child_1.ref();
			this.el.append( child_1.el );
	...
	public class Xcls_SearchBar38 : Object
	{
		...
		// ctor
		public Xcls_SearchBar38(Xcls_MainWindow _owner )
		{
			_this = _owner;
	...
	public class Xcls_Box46 : Object
	{
		...
		// ctor
		public Xcls_Box46(Xcls_MainWindow _owner )
		{
			_this = _owner;
			this.el = new Gtk.Box( Gtk.Orientation.HORIZONTAL, 0 );
	...
	public class Xcls_Paned49 : Object
	{
		...
		// ctor
		public Xcls_Paned49(Xcls_MainWindow _owner )
		{
			_this = _owner;
	...
	public class Xcls_ScrolledWindow50 : Object
	{
		...
		// ctor
		public Xcls_ScrolledWindow50(Xcls_MainWindow _owner )
		{
			_this = _owner;
			...
			var child_1 = new Xcls_ColumnView51( _this );
			this.el.child = child_1.el;
		}
	...
	public class Xcls_ColumnView51 : Object
	{
		...
		// ctor
		public Xcls_ColumnView51(Xcls_MainWindow _owner )
		{
			_this = _owner;
	...
	public class Xcls_winsel : Object
	{
		...
		public Xcls_winsel(Xcls_MainWindow _owner )
		{
			_this = _owner;
			_this.winsel = this;
			var child_1 = new Xcls_SortListModel53( _this );
			child_1.ref();
	...
	public class Xcls_SortListModel53 : Object
	{
		...
		// ctor
		public Xcls_SortListModel53(Xcls_MainWindow _owner )
		{
			_this = _owner;
			new Xcls_winfilter( _this );
			var child_2 = new Xcls_StringSorter58( _this );
			child_2.ref();
	...
	public class Xcls_StringSorter58 : Object
	{
		...
		// ctor
		public Xcls_StringSorter58(Xcls_MainWindow _owner )
		{
			_this = _owner;
			var child_1 = new Xcls_PropertyExpression59( _this );
			child_1.ref();
	...
	public class Xcls_PropertyExpression59 : Object
	{
		public Gtk.PropertyExpression el;
		private Xcls_MainWindow  _this;
		...
		// ctor
		public Xcls_PropertyExpression59(Xcls_MainWindow _owner )
		{
			_this = _owner;
			this.el = new Gtk.PropertyExpression( typeof(WindowState), null, "file_name" );
	...
	public class Xcls_filecol : Object
	{
		...
		public Xcls_filecol(Xcls_MainWindow _owner )
		{
			_this = _owner;
			_this.filecol = this;
			var child_1 = new Xcls_SignalListItemFactory63( _this );
			child_1.ref();
	...
	public class Xcls_SignalListItemFactory63 : Object
	{
		public Gtk.SignalListItemFactory el;
		private Xcls_MainWindow  _this;
		...
		// ctor
		public Xcls_SignalListItemFactory63(Xcls_MainWindow _owner )
		{
			_this = _owner;
			this.el = new Gtk.SignalListItemFactory();
	...
	public class Xcls_treeview : Object
	{
		...
		public Xcls_treeview(Xcls_MainWindow _owner )
		{
			...
			this.el.hexpand = true;
			this.el.vexpand = true;
			var child_2 = new Xcls_GestureClick66( _this );
			child_2.ref();
	...
	public class Xcls_GestureClick66 : Object
	{
		...
		// ctor
		public Xcls_GestureClick66(Xcls_MainWindow _owner )
		{
			_this = _owner;
	...
	public class Xcls_treeselmodel : Object
	{
		...
		public Xcls_treeselmodel(Xcls_MainWindow _owner )
		{
			...
			var child_1 = new Xcls_FilterListModel68( _this );
			child_1.ref();
			this.el = new Gtk.SingleSelection( child_1.el );
	...
	public class Xcls_FilterListModel68 : Object
	{
		public Gtk.FilterListModel el;
		private Xcls_MainWindow  _this;
		...
		// ctor
		public Xcls_FilterListModel68(Xcls_MainWindow _owner )
		{
			_this = _owner;
	...
	public class Xcls_treelistsort : Object
	{
		...
		public Xcls_treelistsort(Xcls_MainWindow _owner )
		{
			...
			var child_2 = new Xcls_TreeListRowSorter72( _this );
			child_2.ref();
	...
	public class Xcls_TreeListRowSorter72 : Object
	{
		...
		// ctor
		public Xcls_TreeListRowSorter72(Xcls_MainWindow _owner )
		{
			_this = _owner;
			var child_1 = new Xcls_StringSorter73( _this );
			child_1.ref();
	...
	public class Xcls_StringSorter73 : Object
	{
		public Gtk.StringSorter el;
		private Xcls_MainWindow  _this;
		...
		// ctor
		public Xcls_StringSorter73(Xcls_MainWindow _owner )
		{
			_this = _owner;
	...
	public class Xcls_PropertyExpression74 : Object
	{
		...
		// ctor
		public Xcls_PropertyExpression74(Xcls_MainWindow _owner )
		{
			_this = _owner;
