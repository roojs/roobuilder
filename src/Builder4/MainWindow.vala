...
public class Xcls_MainWindow : Object
{
    ...
    public Xcls_MainWindow()
    {
        ...
        var child_0 = new Xcls_EventControllerKey2( _this );
        child_0.ref();
    ...
    public class Xcls_EventControllerKey2 : Object
    {
        ...
        // ctor
        public Xcls_EventControllerKey2(Xcls_MainWindow _owner )
        {
            _this = _owner;
    ...
    public class Xcls_windowbtn : Object
    {
        ...
        public Xcls_windowbtn(Xcls_MainWindow _owner )
        {
            ...
            var child_0 = new Xcls_PopoverMenu6( _this );
            child_0.ref();
    ...
    public class Xcls_PopoverMenu6 : Object
    {
    ...
    public class Xcls_popover_menu : Object
    {
        ...
        public Xcls_popover_menu(Xcls_MainWindow _owner )
        {
            ...
            child_0.ref();
            this.el.append (  child_0.el  );
            var child_1 = new Xcls_Separator10( _this );
            child_1.ref();
            this.el.append (  child_1.el  );
        }
    ...
    public class Xcls_Button8 : Object
    {
        ...
        public Xcls_Button8(Xcls_MainWindow _owner )
        {
            ...
            var child_0 = new Xcls_ShortcutController9( _this );
            child_0.ref();
            this.el.add_controller(  child_0.el );
    ...
    public class Xcls_ShortcutController9 : Object
    {
        ...
        // ctor
        public Xcls_ShortcutController9(Xcls_MainWindow _owner )
        {
            _this = _owner;
    ...
    public class Xcls_Separator10 : Object
    {
        ...
        // ctor
        public Xcls_Separator10(Xcls_MainWindow _owner )
        {
            _this = _owner;
    ...
    public class Xcls_Box21 : Object
    {
        ...
        public Xcls_Box21(Xcls_MainWindow _owner )
        {
            ...
            child_1.ref();
            this.el.append(  child_1.el );
            var child_2 = new Xcls_MenuButton24( _this );
            child_2.ref();
            this.el.append(  child_2.el );
            var child_3 = new Xcls_Label29( _this );
            child_3.ref();
            this.el.append(  child_3.el );
            var child_4 = new Xcls_statusbar( _this );
            child_4.ref();
            this.el.append(  child_4.el );
            var child_5 = new Xcls_Box31( _this );
            child_5.ref();
    ...
    public class Xcls_MenuButton24 : Object
    {
        ...
        // ctor
        public Xcls_MenuButton24(Xcls_MainWindow _owner )
        {
            _this = _owner;
            this.el = new Gtk.MenuButton();
    ...
    public class Xcls_Box31 : Object
    {
        ...
        // ctor
        public Xcls_Box31(Xcls_MainWindow _owner )
        {
            _this = _owner;
            this.el = new Gtk.Box( Gtk.Orientation.HORIZONTAL, 0 );
