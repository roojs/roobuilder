...
public class ValaProjectSettingsPopover : Object
{
    ...
    public class Xcls_default_directory_menu : Object
    {
        ...
        public Xcls_default_directory_menu(ValaProjectSettingsPopover _owner )
        {
            ...
            var child_2 = new Xcls_Separator27( _this );
            child_2.ref();
            this.el.add (  child_2.el  );
            var child_3 = new Xcls_Button28( _this );
            child_3.ref();
            this.el.add (  child_3.el  );
            var child_4 = new Xcls_Box29( _this );
            child_4.ref();
    ...
    public class Xcls_Separator27 : Object
    {
        ...
        // ctor
        public Xcls_Separator27(ValaProjectSettingsPopover _owner )
        {
            _this = _owner;
    ...
    public class Xcls_Box29 : Object
    {
        ...
        // ctor
        public Xcls_Box29(ValaProjectSettingsPopover _owner )
        {
            _this = _owner;
    ...
    public class Xcls_targets_tree_menu : Object
    {
        ...
        public Xcls_targets_tree_menu(ValaProjectSettingsPopover _owner )
        {
            ...
            child_0.ref();
            this.el.add (  child_0.el  );
            var child_1 = new Xcls_Separator34( _this );
            child_1.ref();
            this.el.add (  child_1.el  );
            var child_2 = new Xcls_Button35( _this );
            child_2.ref();
            this.el.add (  child_2.el  );
        }
    ...
    public class Xcls_Separator34 : Object
    {
        ...
        // ctor
        public Xcls_Separator34(ValaProjectSettingsPopover _owner )
        {
            _this = _owner;
            this.el = new Gtk.Separator( null );
    ...
    public class Xcls_targets_tree : Object
    {
        ...
        public Xcls_targets_tree(ValaProjectSettingsPopover _owner )
        {
            ...
            child_0.ref();
            this.el.set_model (  child_0.el  );
            var child_1 = new Xcls_TreeViewColumn38( _this );
            child_1.ref();
            this.el.append_column (  child_1.el  );
    ...
    public class Xcls_TreeViewColumn38 : Object
    {
        public Gtk.TreeViewColumn el;
        private ValaProjectSettingsPopover  _this;
        ...
        // ctor
        public Xcls_TreeViewColumn38(ValaProjectSettingsPopover _owner )
        {
            _this = _owner;
            this.el = new Gtk.TreeViewColumn();
    ...
    public class Xcls_set_vbox : Object
    {
        ...
        public Xcls_set_vbox(ValaProjectSettingsPopover _owner )
        {
            ...
            // set gobject values
            this.el.homogeneous = false;
            var child_0 = new Xcls_Label41( _this );
            child_0.ref();
            this.el.append(  child_0.el );
            ...
            var child_4 = new Xcls_Label45( _this );
            child_4.ref();
            this.el.append(  child_4.el );
            var child_5 = new Xcls_build_execute_args( _this );
            child_5.ref();
            this.el.append(  child_5.el );
            var child_6 = new Xcls_Label47( _this );
            child_6.ref();
            this.el.append(  child_6.el );
            var child_7 = new Xcls_ScrolledWindow48( _this );
            child_7.ref();
    ...
    public class Xcls_files_tree : Object
    {
        ...
        public Xcls_files_tree(ValaProjectSettingsPopover _owner )
        {
            ...
            child_0.ref();
            this.el.set_model (  child_0.el  );
            var child_1 = new Xcls_TreeViewColumn51( _this );
            child_1.ref();
            this.el.append_column (  child_1.el  );
