...
public class ValaProjectSettingsPopover : Object
{
    ...
    public class Xcls_Notebook5 : Object
    {
        ...
        public Xcls_Notebook5(ValaProjectSettingsPopover _owner )
        {
            ...
            var child_3 = new Xcls_Paned29( _this );
            child_3.ref();
    ...
    public class Xcls_Box21 : Object
    {
        ...
        public Xcls_Box21(ValaProjectSettingsPopover _owner )
        {
            ...
            // set gobject values
            var child_0 = new Xcls_ScrolledWindow22( _this );
            child_0.ref();
            this.el.append(  child_0.el );
        }
    ...
    public class Xcls_Paned29 : Object
    {
        public Gtk.Paned el;
        private ValaProjectSettingsPopover  _this;
        ...
        // ctor
        public Xcls_Paned29(ValaProjectSettingsPopover _owner )
        {
            _this = _owner;
            this.el = new Gtk.Paned( Gtk.Orientation.HORIZONTAL );
    ...
    public class Xcls_set_vbox : Object
    {
        ...
        public Xcls_set_vbox(ValaProjectSettingsPopover _owner )
        {
            ...
            var child_7 = new Xcls_ScrolledWindow38( _this );
            child_7.ref();
    ...
    public class Xcls_targets_tree : Object
    {
        ...
        public Xcls_targets_tree(ValaProjectSettingsPopover _owner )
        {
            ...
            // set gobject values
            this.el.vexpand = true;
            var child_0 = new Xcls_GestureClick51( _this );
            child_0.ref();
            this.el.add_controller(  child_0.el );
            var child_1 = new Xcls_targets_tree_store( _this );
            child_1.ref();
            this.el.set_model (  child_1.el  );
            var child_2 = new Xcls_TreeViewColumn53( _this );
            child_2.ref();
            this.el.append_column (  child_2.el  );
    ...
    public class Xcls_GestureClick51 : Object
    {
        ...
        // ctor
        public Xcls_GestureClick51(ValaProjectSettingsPopover _owner )
        {
            _this = _owner;
