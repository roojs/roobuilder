...
public class ValaProjectSettingsPopover : Object
{
    ...
    public class Xcls_Notebook5 : Object
    {
        ...
        public Xcls_Notebook5(ValaProjectSettingsPopover _owner )
        {
            ...
            var child_3 = new Xcls_Paned33( _this );
            child_3.ref();
    ...
    public class Xcls_Paned33 : Object
    {
        public Gtk.Paned el;
        private ValaProjectSettingsPopover  _this;
        ...
        // ctor
        public Xcls_Paned33(ValaProjectSettingsPopover _owner )
        {
            _this = _owner;
            this.el = new Gtk.Paned( Gtk.Orientation.HORIZONTAL );
            ...
            this.el.vexpand = true;
            this.el.position = 300;
            var child_0 = new Xcls_ScrolledWindow34( _this );
            child_0.ref();
    ...
    public class Xcls_Box36 : Object
    {
        ...
        // ctor
        public Xcls_Box36(ValaProjectSettingsPopover _owner )
        {
            _this = _owner;
            this.el = new Gtk.Box( Gtk.Orientation.VERTICAL, 0 );
            ...
            child_0.ref();
            this.el.append(  child_0.el );
            var child_1 = new Xcls_Separator38( _this );
            child_1.ref();
            this.el.append(  child_1.el );
    ...
    public class Xcls_Separator38 : Object
    {
        public Gtk.Separator el;
        private ValaProjectSettingsPopover  _this;
        ...
        // ctor
        public Xcls_Separator38(ValaProjectSettingsPopover _owner )
        {
            _this = _owner;
            this.el = new Gtk.Separator( Gtk.Orientation.HORIZONTAL );
    ...
    public class Xcls_targets_tree : Object
    {
        ...
        public Xcls_targets_tree(ValaProjectSettingsPopover _owner )
        {
            ...
            // set gobject values
            this.el.vexpand = true;
            var child_0 = new Xcls_GestureClick41( _this );
            child_0.ref();
            this.el.add_controller(  child_0.el );
    ...
    public class Xcls_GestureClick41 : Object
    {
        ...
        // ctor
        public Xcls_GestureClick41(ValaProjectSettingsPopover _owner )
        {
            _this = _owner;
            this.el = new Gtk.GestureClick();
    ...
    public class Xcls_set_vbox : Object
    {
        ...
        public Xcls_set_vbox(ValaProjectSettingsPopover _owner )
        {
            ...
            // set gobject values
            this.el.homogeneous = false;
            var child_0 = new Xcls_Label46( _this );
            child_0.ref();
            this.el.append(  child_0.el );
            ...
            child_3.ref();
            this.el.append(  child_3.el );
            var child_4 = new Xcls_Label50( _this );
            child_4.ref();
            this.el.append(  child_4.el );
            var child_5 = new Xcls_build_execute_args( _this );
            child_5.ref();
            this.el.append(  child_5.el );
            var child_6 = new Xcls_Label52( _this );
            child_6.ref();
            this.el.append(  child_6.el );
            var child_7 = new Xcls_ScrolledWindow53( _this );
            child_7.ref();
    ...
    public class Xcls_files_tree : Object
    {
        ...
        public Xcls_files_tree(ValaProjectSettingsPopover _owner )
        {
            ...
            child_1.ref();
            this.el.append_column (  child_1.el  );
            var child_2 = new Xcls_TreeViewColumn58( _this );
            child_2.ref();
            this.el.append_column (  child_2.el  );
        }
