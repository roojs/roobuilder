...
public class ValaProjectSettingsPopover : Object
{
    ...
    public class Xcls_Box4 : Object
    {
        ...
        public Xcls_Box4(ValaProjectSettingsPopover _owner )
        {
            ...
            var child_2 = new Xcls_Box71( _this );
            child_2.ref();
    ...
    public class Xcls_ScrolledWindow44 : Object
    {
        ...
        public Xcls_ScrolledWindow44(ValaProjectSettingsPopover _owner )
        {
            ...
            child_0.ref();
            this.el.child = child_0.el;
            var child_1 = new Xcls_ColumnViewColumn55( _this );
            child_1.ref();
            this.el.append(  child_1.el );
...
;
    ...
    public class Xcls_Box62 : Object
    {
        ...
        public Xcls_Box62(ValaProjectSettingsPopover _owner )
        {
            ...
            // set gobject values
            var child_0 = new Xcls_Box63( _this );
            child_0.ref();
            this.el.append(  child_0.el );
    ...
    public class Xcls_ScrolledWindow66 : Object
    {
        ...
        // ctor
        public Xcls_ScrolledWindow66(ValaProjectSettingsPopover _owner )
        {
            _this = _owner;
            this.el = new Gtk.ScrolledWindow();
    ...
    public class Xcls_targets_tree : Object
    {
        ...
        public Xcls_targets_tree(ValaProjectSettingsPopover _owner )
        {
            ...
            child_0.ref();
            this.el.set_model (  child_0.el  );
            var child_1 = new Xcls_TreeViewColumn69( _this );
            child_1.ref();
            this.el.append_column (  child_1.el  );
