...
public class ValaProjectSettingsPopover : Object
{
    ...
    public class Xcls_Notebook7 : Object
    {
        ...
        public Xcls_Notebook7(ValaProjectSettingsPopover _owner )
        {
            ...
            var child_3 = new Xcls_Paned25( _this );
            child_3.ref();
    ...
    public class Xcls_set_vbox : Object
    {
        ...
        public Xcls_set_vbox(ValaProjectSettingsPopover _owner )
        {
            ...
            var child_7 = new Xcls_ScrolledWindow34( _this );
            child_7.ref();
    ...
    public class Xcls_ColumnView35 : Object
    {
        ...
        // ctor
        public Xcls_ColumnView35(ValaProjectSettingsPopover _owner )
        {
            _this = _owner;
            this.el = new Gtk.ColumnView( null );
            ...
            child_1.ref();
            this.el.append_column (  child_1.el  );
            var child_2 = new Xcls_ColumnViewColumn45( _this );
            child_2.ref();
            this.el.append_column (  child_2.el  );
        }
    ...
    public class Xcls_SingleSelection36 : Object
    {
        ...
        // ctor
        public Xcls_SingleSelection36(ValaProjectSettingsPopover _owner )
        {
            _this = _owner;
    ...
    public class Xcls_SortListModel38 : Object
    {
        ...
        // ctor
        public Xcls_SortListModel38(ValaProjectSettingsPopover _owner )
        {
            _this = _owner;
            this.el = new Gtk.SortListModel( null, null );
