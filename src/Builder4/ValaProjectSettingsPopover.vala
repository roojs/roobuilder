...
public class ValaProjectSettingsPopover : Object
{
    ...
    public class Xcls_targets_tree_menu : Object
    {
        ...
        public Xcls_targets_tree_menu(ValaProjectSettingsPopover _owner )
        {
            ...
            // set gobject values
            var child_0 = new Xcls_Separator34( _this );
            child_0.ref();
    ...
    public class Xcls_GestureClick39 : Object
    {
        ...
        // ctor
        public Xcls_GestureClick39(ValaProjectSettingsPopover _owner )
        {
            _this = _owner;
            this.el = new Gtk.GestureClick();
    ...
    public class Xcls_set_vbox : Object
    {
        ...
        public Xcls_set_vbox(ValaProjectSettingsPopover _owner )
        {
            ...
            // set gobject values
            this.el.homogeneous = false;
            var child_0 = new Xcls_Label44( _this );
            child_0.ref();
            this.el.append(  child_0.el );
            ...
            child_3.ref();
            this.el.append(  child_3.el );
            var child_4 = new Xcls_Label48( _this );
            child_4.ref();
            this.el.append(  child_4.el );
            var child_5 = new Xcls_build_execute_args( _this );
            child_5.ref();
            this.el.append(  child_5.el );
            var child_6 = new Xcls_Label50( _this );
            child_6.ref();
            this.el.append(  child_6.el );
            var child_7 = new Xcls_ScrolledWindow51( _this );
            child_7.ref();
