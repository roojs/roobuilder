...
public class Xcls_GladeuiView : Object
{
	...
	public Xcls_GladeuiView()
	{
		...
		var child_1 = new Xcls_Button1( _this );
		child_1.ref();
		this.el.append( child_1.el );
		var child_2 = new Xcls_GestureClick4( _this );
		child_2.ref();
		this.el.add_controller ( child_2.el  );
		var child_3 = new Xcls_ColumnView5( _this );
		child_3.ref();
		this.el.append( child_3.el );
		new Xcls_notebook( _this );
		this.el.pack_start ( _this.notebook.el , true,true,0 );
	...
	public class Xcls_Button1 : Object
	{
		...
		// ctor
		public Xcls_Button1(Xcls_GladeuiView _owner )
		{
			_this = _owner;
	...
	public class Xcls_Box2 : Object
	{
		...
		// ctor
		public Xcls_Box2(Xcls_GladeuiView _owner )
		{
			_this = _owner;
	...
	public class Xcls_GestureClick3 : Object
	{
		...
		// ctor
		public Xcls_GestureClick3(Xcls_GladeuiView _owner )
		{
			_this = _owner;
	...
	public class Xcls_ColumnView5 : Object
	{
		...
		{
			_this = _owner;
			var child_1 = new Xcls_SingleSelection6( _this );
			child_1.ref();
	...
	public class Xcls_SingleSelection6 : Object
	{
		...
		{
			_this = _owner;
			var child_1 = new Xcls_TreeListModel7( _this );
			child_1.ref();
	...
	public class Xcls_TreeListModel7 : Object
	{
		...
		// ctor
		public Xcls_TreeListModel7(Xcls_GladeuiView _owner )
		{
			_this = _owner;
	...
	public class Xcls_ColumnViewColumn8 : Object
	{
		...
		// ctor
		public Xcls_ColumnViewColumn8(Xcls_GladeuiView _owner )
		{
			_this = _owner;
	...
	public class Xcls_notebook : Object
	{
		...
		public Xcls_notebook(Xcls_GladeuiView _owner )
		{
			...
			new Xcls_designview( _this );
			new Xcls_sourceview( _this );
			this.el.append_page ( _this.sourceview.el , _this.label_code.el );
		}
	...
	public class Xcls_designview : Object
	{
		...
		// my vars (def)
		/* Symbol loader failed to find Glade.DesignView */
	...
	public class Xcls_sourceview : Object
	{
		...
		// my vars (def)
		/* Symbol loader failed to find Gtk.SourceView */
