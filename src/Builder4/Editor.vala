...
public class Editor : Object
{
	...
	public class Xcls_view : Object
	{
		...
		public Xcls_view(Editor _owner )
		{
			...
			var child_2 = new Xcls_EventControllerScroll13( _this );
			child_2.ref();
			this.el.add_controller(  child_2.el );
			var child_3 = new Xcls_GestureClick14( _this );
			child_3.ref();
			this.el.add_controller(  child_3.el );
			var child_4 = new Xcls_EventControllerKey15( _this );
			child_4.ref();
	...
	public class Xcls_EventControllerScroll13 : Object
	{
		...
		public Xcls_EventControllerScroll13(Editor _owner )
		{
			...
			this.el.scroll.connect( (dx, dy) => {
				...
				var is_control = 
					0 != (_this.window.keyboard.get_modifier_state() & Gdk.ModifierType.CONTROL_MASK);
	...
	public class Xcls_EventControllerKey15 : Object
	{
		...
		// ctor
		public Xcls_EventControllerKey15(Editor _owner )
		{
			_this = _owner;
