...
public class DialogFiles : Object
{
	...
	public class Xcls_Box49 : Object
	{
		...
		public Xcls_Box49(DialogFiles _owner )
		{
			...
			// set gobject values
			this.el.hexpand = true;
			new Xcls_filter_( _this );
			this.el.append( _this.filter_.el );
	...
	public class Xcls_filter_ : Object
	{
		public Gtk.ToggleButton el;
		private DialogFiles  _this;
		...
		// ctor
		public Xcls_filter_(DialogFiles _owner )
		{
			_this = _owner;
			_this.filter_ = this;
			this.el = new Gtk.ToggleButton();
