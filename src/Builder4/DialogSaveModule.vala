...
public class DialogSaveModule : Object
{
	...
	public DialogSaveModule()
	{
		...
		this.el.response.connect( (response_id) => {
		   ...
		   var  name = _this.name.el.get_text();
		    ...
		    f.tree = Json.gobject_deserialize( typeof(JsRender.Node),
	...
	public class Xcls_Box1 : Object
	{
		...
		// ctor
		public Xcls_Box1(DialogSaveModule _owner )
		{
			_this = _owner;
	...
	public class Xcls_Label2 : Object
	{
		...
		// ctor
		public Xcls_Label2(DialogSaveModule _owner )
		{
			_this = _owner;
	...
	public class Xcls_Button4 : Object
	{
		...
		// ctor
		public Xcls_Button4(DialogSaveModule _owner )
		{
			_this = _owner;
