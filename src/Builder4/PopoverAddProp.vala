...
public class Xcls_PopoverAddProp : Object
{
    ...
    public class Xcls_ColumnViewSorter5 : Object
    {
        ...
        // ctor
        public Xcls_ColumnViewSorter5(Xcls_PopoverAddProp _owner )
        {
            _this = _owner;
            this.el = new Gtk.ColumnViewSorter();
    ...
    public class Xcls_"" : Object
    {
        ...
        // ctor
        public Xcls_""(Xcls_PopoverAddProp _owner )
        {
            _this = _owner;
            _this."" = this;
