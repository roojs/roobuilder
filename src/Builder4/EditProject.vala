...
public class EditProject : Object
{
	...
	public class Xcls_HeaderBar1 : Object
	{
		...
		// ctor
		public Xcls_HeaderBar1(EditProject _owner )
		{
			_this = _owner;
			...
			var child_1 = new Xcls_Button2( _this );
			child_1.ref();
	...
	public class Xcls_Button2 : Object
	{
		...
		// ctor
		public Xcls_Button2(EditProject _owner )
		{
			_this = _owner;
	...
	public class Xcls_Box4 : Object
	{
		...
		// ctor
		public Xcls_Box4(EditProject _owner )
		{
			_this = _owner;
			...
			var child_1 = new Xcls_Grid5( _this );
			child_1.ref();
	...
	public class Xcls_Grid5 : Object
	{
		public Gtk.Grid el;
		private EditProject  _this;
		...
		// ctor
		public Xcls_Grid5(EditProject _owner )
		{
			_this = _owner;
	...
	public class Xcls_type_dd : Object
	{
		...
		public Xcls_type_dd(EditProject _owner )
		{
			_this = _owner;
			_this.type_dd = this;
			var child_1 = new Xcls_StringList8( _this );
			child_1.ref();
			...
			this.el.notify["selected"].connect( ( ) => {
				...
				if ("(select)" == m.get_string(this.el.selected)) {
					return;
				}
	...
	public class Xcls_StringList8 : Object
	{
		...
		// ctor
		public Xcls_StringList8(EditProject _owner )
		{
			_this = _owner;
	...
	public class Xcls_parent_dd : Object
	{
		...
		public Xcls_parent_dd(EditProject _owner )
		{
			...
			//listeners
			this.el.notify["selected"].connect( ( ) => {
				if (this.el.selected == Gtk.INVALID_LIST_POSITION || this.getValue() == "(select)") {
					_this.hideAll();
					_this.parent_lbl.el.show();
			     	_this.parent_dd.el.show();   
	...
	public class Xcls_StringList11 : Object
	{
		...
		// ctor
		public Xcls_StringList11(EditProject _owner )
		{
			_this = _owner;
			this.el = new Gtk.StringList( { "(select)", "gitlive", "Projects", "Select" } );
	...
	public class Xcls_folder_dd : Object
	{
		...
		public Xcls_folder_dd(EditProject _owner )
		{
			...
			var child_1 = new Xcls_StringList14( _this );
			child_1.ref();
			this.el = new Gtk.DropDown( child_1.el, null );
	...
	public class Xcls_ptype_dd : Object
	{
		...
		public Xcls_ptype_dd(EditProject _owner )
		{
			_this = _owner;
			_this.ptype_dd = this;
			var child_1 = new Xcls_StringList19( _this );
			child_1.ref();
			this.el = new Gtk.DropDown( child_1.el, null );
	...
	public class Xcls_StringList19 : Object
	{
		public Gtk.StringList el;
		private EditProject  _this;
		...
		// ctor
		public Xcls_StringList19(EditProject _owner )
		{
			_this = _owner;
