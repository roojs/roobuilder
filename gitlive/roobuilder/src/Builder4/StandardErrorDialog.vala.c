...
static gboolean __lambda42_ (Xcls_StandardErrorDialog* self, GtkWidget* _self_, GdkEventAny* event);
static gboolean ___lambda42__gtk_widget_delete_event (GtkWidget* _sender, GdkEventAny* event, gpointer self);
static void __lambda43_ (Xcls_StandardErrorDialog* self, GtkDialog* _self_, gint response_id);
...
#line 30 "/home/alan/gitlive/roobuilder/src/Builder4/StandardErrorDialog.vala"
...
#line 27 "/home/alan/gitlive/roobuilder/src/Builder4/StandardErrorDialog.vala"
	_tmp0_ = StandardErrorDialog;
#line 27 "/home/alan/gitlive/roobuilder/src/Builder4/StandardErrorDialog.vala"
	if (_tmp0_ == NULL) {
#line 90 "StandardErrorDialog.vala.c"
		Xcls_StandardErrorDialog* _tmp1_ = NULL;
#line 28 "/home/alan/gitlive/roobuilder/src/Builder4/StandardErrorDialog.vala"
...
#line 49 "/home/alan/gitlive/roobuilder/src/Builder4/StandardErrorDialog.vala"
	_tmp0_ = self->el;
#line 49 "/home/alan/gitlive/roobuilder/src/Builder4/StandardErrorDialog.vala"
	gtk_widget_hide ((GtkWidget*) _tmp0_);
#line 50 "/home/alan/gitlive/roobuilder/src/Builder4/StandardErrorDialog.vala"
	result = TRUE;
#line 50 "/home/alan/gitlive/roobuilder/src/Builder4/StandardErrorDialog.vala"
	return result;
#line 123 "StandardErrorDialog.vala.c"
}


static gboolean ___lambda42__gtk_widget_delete_event (GtkWidget* _sender, GdkEventAny* event, gpointer self) {
	gboolean result;
	result = __lambda42_ ((Xcls_StandardErrorDialog*) self, _sender, event);
#line 48 "/home/alan/gitlive/roobuilder/src/Builder4/StandardErrorDialog.vala"
	return result;
...
static void __lambda43_ (Xcls_StandardErrorDialog* self, GtkDialog* _self_, gint response_id) {
	GtkMessageDialog* _tmp0_ = NULL;
#line 55 "/home/alan/gitlive/roobuilder/src/Builder4/StandardErrorDialog.vala"
	_tmp0_ = self->el;
#line 55 "/home/alan/gitlive/roobuilder/src/Builder4/StandardErrorDialog.vala"
	gtk_widget_hide ((GtkWidget*) _tmp0_);
...
static void ___lambda43__gtk_dialog_response (GtkDialog* _sender, gint response_id, gpointer self) {
#line 54 "/home/alan/gitlive/roobuilder/src/Builder4/StandardErrorDialog.vala"
	__lambda43_ ((Xcls_StandardErrorDialog*) self, _sender, response_id);
...
#line 36 "/home/alan/gitlive/roobuilder/src/Builder4/StandardErrorDialog.vala"
	self = (Xcls_StandardErrorDialog*) g_object_new (object_type, NULL);
#line 38 "/home/alan/gitlive/roobuilder/src/Builder4/StandardErrorDialog.vala"
	_tmp0_ = _g_object_ref0 (self);
#line 38 "/home/alan/gitlive/roobuilder/src/Builder4/StandardErrorDialog.vala"
	_g_object_unref0 (self->priv->_this);
#line 38 "/home/alan/gitlive/roobuilder/src/Builder4/StandardErrorDialog.vala"
	self->priv->_this = _tmp0_;
#line 39 "/home/alan/gitlive/roobuilder/src/Builder4/StandardErrorDialog.vala"
...
#line 39 "/home/alan/gitlive/roobuilder/src/Builder4/StandardErrorDialog.vala"
	self->el = _tmp1_;
#line 44 "/home/alan/gitlive/roobuilder/src/Builder4/StandardErrorDialog.vala"
	_tmp2_ = self->el;
#line 44 "/home/alan/gitlive/roobuilder/src/Builder4/StandardErrorDialog.vala"
	gtk_window_set_modal ((GtkWindow*) _tmp2_, TRUE);
#line 45 "/home/alan/gitlive/roobuilder/src/Builder4/StandardErrorDialog.vala"
	_tmp3_ = self->el;
#line 45 "/home/alan/gitlive/roobuilder/src/Builder4/StandardErrorDialog.vala"
...
#line 48 "/home/alan/gitlive/roobuilder/src/Builder4/StandardErrorDialog.vala"
	_tmp4_ = self->el;
#line 48 "/home/alan/gitlive/roobuilder/src/Builder4/StandardErrorDialog.vala"
	g_signal_connect_object ((GtkWidget*) _tmp4_, "delete-event", (GCallback) ___lambda42__gtk_widget_delete_event, self, 0);
#line 54 "/home/alan/gitlive/roobuilder/src/Builder4/StandardErrorDialog.vala"
	_tmp5_ = self->el;
#line 54 "/home/alan/gitlive/roobuilder/src/Builder4/StandardErrorDialog.vala"
	g_signal_connect_object ((GtkDialog*) _tmp5_, "response", (GCallback) ___lambda43__gtk_dialog_response, self, 0);
#line 36 "/home/alan/gitlive/roobuilder/src/Builder4/StandardErrorDialog.vala"
	return self;
#line 195 "StandardErrorDialog.vala.c"
}
...
void xcls_standarderrordialog_show (Xcls_StandardErrorDialog* self, GtkWindow* win, const gchar* msg) {
	...
	GtkMessageDialog* _tmp5_ = NULL;
#line 62 "/home/alan/gitlive/roobuilder/src/Builder4/StandardErrorDialog.vala"
	_tmp0_ = self->el;
#line 62 "/home/alan/gitlive/roobuilder/src/Builder4/StandardErrorDialog.vala"
	_tmp1_ = win;
#line 62 "/home/alan/gitlive/roobuilder/src/Builder4/StandardErrorDialog.vala"
	gtk_window_set_transient_for ((GtkWindow*) _tmp0_, _tmp1_);
#line 63 "/home/alan/gitlive/roobuilder/src/Builder4/StandardErrorDialog.vala"
	_tmp2_ = self->el;
#line 63 "/home/alan/gitlive/roobuilder/src/Builder4/StandardErrorDialog.vala"
	gtk_window_set_modal ((GtkWindow*) _tmp2_, TRUE);
#line 64 "/home/alan/gitlive/roobuilder/src/Builder4/StandardErrorDialog.vala"
	_tmp3_ = self->el;
#line 64 "/home/alan/gitlive/roobuilder/src/Builder4/StandardErrorDialog.vala"
	_tmp4_ = msg;
#line 64 "/home/alan/gitlive/roobuilder/src/Builder4/StandardErrorDialog.vala"
	g_object_set (_tmp3_, "text", _tmp4_, NULL);
#line 65 "/home/alan/gitlive/roobuilder/src/Builder4/StandardErrorDialog.vala"
	_tmp5_ = self->el;
#line 65 "/home/alan/gitlive/roobuilder/src/Builder4/StandardErrorDialog.vala"
...
#line 20 "/home/alan/gitlive/roobuilder/src/Builder4/StandardErrorDialog.vala"
...
#line 244 "StandardErrorDialog.vala.c"
}
...
#line 22 "/home/alan/gitlive/roobuilder/src/Builder4/StandardErrorDialog.vala"
	_g_object_unref0 (self->el);
#line 23 "/home/alan/gitlive/roobuilder/src/Builder4/StandardErrorDialog.vala"
	_g_object_unref0 (self->priv->_this);
#line 20 "/home/alan/gitlive/roobuilder/src/Builder4/StandardErrorDialog.vala"
