...
static void __lambda102_ (Xcls_StandardErrorDialog* self,
                   GtkDialog* _self_,
                   gint response_id);
...
static void
__lambda102_ (Xcls_StandardErrorDialog* self,
              GtkDialog* _self_,
              gint response_id)
{
...
#line 31 "StandardErrorDialog.vala"
	__lambda102_ ((Xcls_StandardErrorDialog*) self, _sender, response_id);
...
#line 31 "StandardErrorDialog.vala"
	_tmp4_ = self->el;
#line 31 "StandardErrorDialog.vala"
	g_signal_connect_object ((GtkDialog*) _tmp4_, "response", (GCallback) ___lambda102__gtk_dialog_response, self, 0);
#line 19 "StandardErrorDialog.vala"
	return self;
