/* valaccodeexpression.vala.c generated by valac, the Vala compiler
...
vala_ccode_expression_real_write_inner (ValaCCodeExpression* self,
                                        ValaCCodeWriter* writer)
{
#line 30 "valaccodeexpression.vala"
	vala_ccode_node_write ((ValaCCodeNode*) self, writer);
#line 147 "valaccodeexpression.vala.c"
}
...
vala_ccode_expression_write_inner (ValaCCodeExpression* self,
                                   ValaCCodeWriter* writer)
{
	ValaCCodeExpressionClass* _klass_;
#line 29 "valaccodeexpression.vala"
	_klass_ = VALA_CCODE_EXPRESSION_GET_CLASS (self);
#line 29 "valaccodeexpression.vala"
	if (_klass_->write_inner) {
#line 29 "valaccodeexpression.vala"
		_klass_->write_inner (self, writer);
#line 161 "valaccodeexpression.vala.c"
	}
}
...
#line 28 "valaccodeexpression.vala"
	self = (ValaCCodeExpression*) vala_ccode_node_construct (object_type);
#line 28 "valaccodeexpression.vala"
	return self;
#line 173 "valaccodeexpression.vala.c"
}
...
#line 184 "valaccodeexpression.vala.c"
}
...
{
	static volatile gsize vala_ccode_expression_type_id__once = 0;
	if (g_once_init_enter (&vala_ccode_expression_type_id__once)) {
		GType vala_ccode_expression_type_id;
		vala_ccode_expression_type_id = vala_ccode_expression_get_type_once ();
		g_once_init_leave (&vala_ccode_expression_type_id__once, vala_ccode_expression_type_id);
	}
	return vala_ccode_expression_type_id__once;
}
