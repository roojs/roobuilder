...
static void ___lambda266__g_application_activate (GApplication* _sender,
                                           gpointer self);
...
static void
___lambda266__g_application_activate (GApplication* _sender,
                                      gpointer self)
{
#line 24 "Main.vala"
	__lambda266_ ();
...
#line 24 "Main.vala"
	g_signal_connect ((GApplication*) app, "activate", (GCallback) ___lambda266__g_application_activate, NULL);
#line 38 "Main.vala"
