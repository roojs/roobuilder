...
VALA_EXTERN DialogSaveModuleXcls_Button6* dialog_save_module_xcls_button6_construct (GType object_type,
                                                                         DialogSaveModule* _owner);
static void __lambda105_ (DialogSaveModule* self,
                   gint response_id);
...
static void ___lambda105__gtk_dialog_response (GtkDialog* _sender,
                                        gint response_id,
                                        gpointer self);
...
static void
__lambda105_ (DialogSaveModule* self,
              gint response_id)
{
	gchar* name = NULL;
	DialogSaveModule* _tmp1_;
...
static void
___lambda105__gtk_dialog_response (GtkDialog* _sender,
                                   gint response_id,
                                   gpointer self)
{
#line 45 "DialogSaveModule.vala"
	__lambda105_ ((DialogSaveModule*) self, response_id);
...
#line 45 "DialogSaveModule.vala"
	_tmp18_ = self->el;
#line 45 "DialogSaveModule.vala"
	g_signal_connect_object (_tmp18_, "response", (GCallback) ___lambda105__gtk_dialog_response, self, 0);
#line 23 "DialogSaveModule.vala"
