...
static void __lambda106_ (Xcls_StandardErrorDialog* self,
                   GtkDialog* _self_,
                   gint response_id);
static void ___lambda106__gtk_dialog_response (GtkDialog* _sender,
                                        gint response_id,
                                        gpointer self);
...
static void
__lambda106_ (Xcls_StandardErrorDialog* self,
              GtkDialog* _self_,
              gint response_id)
{
...
static void
___lambda106__gtk_dialog_response (GtkDialog* _sender,
                                   gint response_id,
                                   gpointer self)
{
#line 31 "StandardErrorDialog.vala"
	__lambda106_ ((Xcls_StandardErrorDialog*) self, _sender, response_id);
...
#line 31 "StandardErrorDialog.vala"
	_tmp4_ = self->el;
#line 31 "StandardErrorDialog.vala"
	g_signal_connect_object ((GtkDialog*) _tmp4_, "response", (GCallback) ___lambda106__gtk_dialog_response, self, 0);
#line 19 "StandardErrorDialog.vala"
	return self;
