...
static gboolean __lambda267_ (DialogConfirm* self,
                       GtkWindow* event);
static gboolean ___lambda267__gtk_window_close_request (GtkWindow* _sender,
                                                 gpointer self);
...
static gboolean
__lambda267_ (DialogConfirm* self,
              GtkWindow* event)
{
...
static gboolean
___lambda267__gtk_window_close_request (GtkWindow* _sender,
                                        gpointer self)
{
	gboolean result;
	result = __lambda267_ ((DialogConfirm*) self, _sender);
...
#line 33 "DialogConfirm.vala"
	_tmp6_ = self->el;
#line 33 "DialogConfirm.vala"
	g_signal_connect_object ((GtkWindow*) _tmp6_, "close-request", (GCallback) ___lambda267__gtk_window_close_request, self, 0);
#line 19 "DialogConfirm.vala"
	return self;
