...
static void __lambda240_ (Block13Data* _data13_,
                   JsonObject* o,
                   const gchar* key,
                   JsonNode* value);
static void ___lambda240__json_object_foreach (JsonObject* object,
...
static void
__lambda240_ (Block13Data* _data13_,
              JsonObject* o,
              const gchar* key,
              JsonNode* value)
{
...
static void
___lambda240__json_object_foreach (JsonObject* object,
                                   const gchar* member_name,
                                   JsonNode* member_node,
                                   gpointer self)
{
#line 128 "Gir.vala"
	__lambda240_ (self, object, member_name, member_node);
#line 767 "Gir.vala.c"
}
...
#line 128 "Gir.vala"
	json_object_foreach_member (_tmp17_, ___lambda240__json_object_foreach, _data13_);
#line 134 "Gir.vala"
